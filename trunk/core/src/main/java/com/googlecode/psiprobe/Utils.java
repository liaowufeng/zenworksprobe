...
public class Utils {
    ...
    public static void sendFile(HttpServletRequest request, HttpServletResponse response, File file, boolean shouldDeleteAfterSend) throws IOException {
	...
	public static String getFormattedString(String xmlString)
    {
	    StringBuffer formattedString = new StringBuffer();
	    int i=0;
	    for(i=0; i<xmlString.length()-1; i++)
	    {
	    	char character = xmlString.charAt(i);
	    	formattedString.append(character);
	    	if((character ==  '>')&&((xmlString.charAt(i+1) == ' ') || (xmlString.charAt(i+1) == '\t')))
	    	{
	    		formattedString.append("\r\n");
	    	}
	    }
	    formattedString.append(xmlString.charAt(i));
